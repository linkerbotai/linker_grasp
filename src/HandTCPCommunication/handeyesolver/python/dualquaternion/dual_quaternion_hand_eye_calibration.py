...
from dualquaternion.dual_quaternion import DualQuaternion
from dualquaternion.quaternion import (
    Quaternion, angle_between_quaternions)
from dualquaternion.hand_eye_calibration_plotting_tools import (
...
def compute_hand_eye_calibration(dq_B_H_vec_inliers, dq_W_E_vec_inliers,
  ...
  for j in range(n_quaternions):
    dq_W_E = dq_W_E_vec_inliers[j]
    dq_B_H = dq_B_H_vec_inliers[j]
  ...
  t_matrix = setup_t_matrix(dq_W_E_vec_inliers, dq_B_H_vec_inliers)
  #t_matrix = setup_t_matrix(dq_B_H_vec_inliers, dq_W_E_vec_inliers) # here need to make some modification
